...
exports.buildSajuSystemPrompt = buildSajuSystemPrompt;
exports.buildSajuUserPrompt = buildSajuUserPrompt;
exports.summarizeSajuForSearch = summarizeSajuForSearch;
/**
 * 시스템 프롬프트 생성
 */
function buildSajuSystemPrompt(context) {
 ...
 * 사용자 프롬프트 생성
 */
function buildSajuUserPrompt(sajuDataText, myeongriDataText, birthInfo, additionalQuery) {
 ...
 * 사주 데이터 요약 (RAG 검색용)
 */
function summarizeSajuForSearch(dayStem, dayElement, keywords) {
    return `${dayStem}${dayElement} 일간 ${keywords.join(' ')} 사주 분석`;
}
//# sourceMappingURL=saju_prompt.js.map