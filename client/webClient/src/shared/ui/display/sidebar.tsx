...
import {
    ...
    SheetHeader,
    SheetTitle,
} from "@/shared/ui/feedback/sheet"
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
    TooltipTrigger,
} from "@/shared/ui/display/tooltip"
...
>(
    (
        ...
        // We add a state so that we can use it as a data attribute on the provider.
                ...
                <div
                    className={cn(
                        ...
                        variant === "floating" || variant === "inset"
                            ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_var(--sidebar-main-gap))]"
                            : "group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)]"
                    )}
                />
                <div
                    className={cn(
                        "duration-200 fixed inset-y-0 z-10 hidden h-svh w-[var(--sidebar-width)] take-up-space transition-[left,right,width] ease-linear md:flex",
                        side === "left"
                            ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
                            : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
                        // Adjust the padding for floating and inset variants.
                        variant === "floating" || variant === "inset"
                            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_var(--sidebar-main-gap)_+_(2*var(--sidebar-main-padding)))]"
...
>(({ className, showIcon = false, ...props }, ref) => {
    ...
    return (
        ...
        >
            ...
            <div
                className="h-4 flex-1 max-w-[--skeleton-width] bg-sidebar-accent/50 rounded-md"
